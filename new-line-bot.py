...
def c_reply(username):
    reply= 
    [
    "紗倉まなだよ♡元気出して！","たばこ吸えば？一本と言わず三本くらい","明日ラモ全６らしいよ。朝一フィジカル発揮するべ","一発抜いて落ち着こ。そしたら向こう側の世界へ行けるっしょ",
    ...
    "欲望の沼にどっぷりはまってみてはいかが？","やって後悔するほうがいいなんて言っているの、やってしまって後悔の味を知らない無責任な第三者の言葉だから","ドンマイドンマイ。今のは失敗じゃなくておっぱい",
